        ...
        <nav className="bg-white/95 backdrop-blur-md shadow-lg sticky top-0 z-50 transition-all duration-300">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between h-24 items-center">
            <Link to="/" className="flex items-center group">
              <Tooth className="h-10 w-10 text-primary group-hover:scale-110 transition-transform duration-300" />
              <div className="ml-3 flex flex-col">
                <span className="text-2xl font-bold text-primary tracking-tight font-serif">
                  {t('doctorName')}
                </span>
                <span className="text-xs text-accent tracking-widest uppercase">Dental Clinic</span>
              </div>
            </Link>
            ...
            <div className="grid md:grid-cols-4 gap-12">
              <div className="col-span-1 md:col-span-2">
                <div className="flex items-center mb-6">
                  ...
                  <span className="ml-3 text-2xl font-bold font-serif">{t('doctorName')}</span>
                </div>
