...
const FacetasTurismo = () => {
    const { t } = useTranslation();
    const [openFaq, setOpenFaq] = React.useState<number | null>(null);

    const faqItems = [
        { q: t('veneersFaqQ1'), a: t('veneersFaqA1') },
        { q: t('veneersFaqQ2'), a: t('veneersFaqA2') },
        { q: t('veneersFaqQ3'), a: t('veneersFaqA3') },
        { q: t('veneersFaqQ4'), a: t('veneersFaqA4') },
    ...
    return (
        <div className="animate-fadeIn font-sans text-gray-800">
            ...
            {/* 3. O que são (Premium Layout) */}
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="relative h-[500px] rounded-[3rem] overflow-hidden shadow-2xl group border-4 border-white transition-transform hover:scale-[1.02] duration-500">
                            <img
                        ...
                        <div>
                            <span className="text-accent font-bold uppercase tracking-wider mb-2 block text-xs">{t('veneersDefinitionSubtitle')}</span>
            ...
            <section className="py-24 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                         <h2 className="text-4xl font-bold text-primary font-serif">{t('veneersComparisonTitle')}</h2>
                    </div>

                    <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                        <div className="bg-white p-10 rounded-[2.5rem] shadow-xl border border-gray-100 relative overflow-hidden group hover:-translate-y-2 transition-all duration-300">
                            <div className="w-16 h-16 bg-accent/10 rounded-2xl flex items-center justify-center text-accent mb-8">
                                <Sparkles className="w-8 h-8" />
                            </div>
                            <h3 className="text-3xl font-bold text-primary mb-4">{t('veneersPorcelainTitle')}</h3>
                            <p className="text-gray-500 mb-8 italic leading-relaxed">{t('veneersPorcelainDesc')}</p>
                            <ul className="space-y-4 mb-8">
                                <li className="flex items-center text-gray-700 font-medium"><CheckCircle2 className="w-5 h-5 text-accent mr-3" />{t('veneersPorcelainBen1')}</li>
                                <li className="flex items-center text-gray-700 font-medium"><CheckCircle2 className="w-5 h-5 text-accent mr-3" />{t('veneersPorcelainBen2')}</li>
                                <li className="flex items-center text-gray-700 font-medium"><CheckCircle2 className="w-5 h-5 text-accent mr-3" />{t('veneersPorcelainBen3')}</li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white p-10 rounded-[2.5rem] shadow-xl border border-gray-100 relative overflow-hidden group hover:-translate-y-2 transition-all duration-300">
                            ...
                            <h3 className="text-3xl font-bold text-primary mb-4">{t('veneersResinTitle')}</h3>
                            <p className="text-gray-500 mb-8 italic leading-relaxed">{t('veneersResinDesc')}</p>
                            <ul className="space-y-4 mb-8">
                                <li className="flex items-center text-gray-700 font-medium"><CheckCircle2 className="w-5 h-5 text-primary mr-3" />{t('veneersResinBen1')}</li>
                                <li className="flex items-center text-gray-700 font-medium"><CheckCircle2 className="w-5 h-5 text-primary mr-3" />{t('veneersResinBen2')}</li>
                                <li className="flex items-center text-gray-700 font-medium"><CheckCircle2 className="w-5 h-5 text-primary mr-3" />{t('veneersResinBen3')}</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-24 bg-primary text-white relative overflow-hidden text-center">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <h2 className="text-3xl md:text-4xl font-bold mb-16 font-serif">{t('veneersIndicationsTitle')}</h2>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                        {[
                            ...
                            <div key={idx} className="bg-white/10 backdrop-blur-md p-8 rounded-3xl border border-white/20 hover:bg-white/20 transition-all flex items-center justify-center min-h-[140px] shadow-lg">
            ...
            <section className="py-24 bg-white">
             ...
             <section className="py-24 bg-gray-50">
                <div className="max-w-4xl mx-auto px-4">
                    <div className="text-center mb-16">
                        <span className="text-accent font-bold uppercase tracking-widest mb-2 block">{t('veneersFaqSubtitle')}</span>
                        <h2 className="text-4xl font-bold text-primary font-serif">{t('veneersFaqTitle')}</h2>
                    </div>
                    <div className="space-y-4">
            ...
            {/* Final Appointment Section */}
            <AppointmentSection defaultTreatment="facetas" pageName="Facetas Turismo" />
        </div>
    );
};

export default FacetasTurismo;
